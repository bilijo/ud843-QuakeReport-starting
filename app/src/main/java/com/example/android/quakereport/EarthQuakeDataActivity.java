...
public class EarthQuakeDataActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EarthQuakeDataAsyncTask task = new EarthQuakeDataAsyncTask();
...
/*
     ...
     * an output type. Our task will take a String URL, and return an EarthQuakeData. We won't do
     ...
     */
    private class EarthQuakeDataAsyncTask extends AsyncTask<String, Void, List<EarthQuakeData>> {
        ...
        protected List<EarthQuakeData> doInBackground(String... urls) {
            ...
            List<EarthQuakeData> result = QueryUtils.fetchEarthQuakeDataData(urls[0]);
            return result;
        }
