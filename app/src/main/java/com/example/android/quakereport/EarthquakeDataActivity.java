...
public class EarthquakeDataActivity extends AppCompatActivity  implements LoaderCallbacks<List<EarthQuakeData>> {
     ...
     */
    // Test message display then the url didn't match
  //  private static final String USGS_REQUEST_URL ="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        We can use the ListView setEmptyView() method. We can also make the empty state TextView be a global variable,
