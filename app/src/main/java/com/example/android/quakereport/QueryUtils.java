...
public final class QueryUtils {
    ...
    public static ArrayList<EarthQuakeData> extractEarthquakes() {
        ...
        // Create an empty ArrayList that we can start adding earthQuakeDatas to
        ...
        try {
            ...
            Add earthquake to list of earthQuakeDatas */
            ...
            for (i=0 ; i <featuresArray.length() ; i++) {
                ...
                //localisation - place
                // trunc the localisation string into two pieces , "of" is the borderline word

                String placeDesignation="";
                String placeKm;
                String[] dividePlaceByTwo ={"",""};
                if (place.contains("of")){
                    dividePlaceByTwo = place.split("of",-2);
                    placeKm = dividePlaceByTwo[0];
                    placeDesignation = dividePlaceByTwo[1];

                } else {
                    placeKm = dividePlaceByTwo[0].replace("","Near the");
                    placeDesignation = place;
                }
                Log.v("toto", "placeDesignation : "+ dividePlaceByTwo[1]);
        ...
        // Return the list of earthQuakeDatas
